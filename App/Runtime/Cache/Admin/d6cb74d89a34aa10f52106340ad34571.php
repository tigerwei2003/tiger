...
<link rel="stylesheet" href="/gloudapi2/Public/static/css/uniform.css" />
		...
		<div id="content">
			...
			<div id="breadcrumb">
				...
				<a href="<?php echo U('Codecard/card_mul');?>" class="current">充值卡销售记录</a>
					...
					<div class="span12">
                        ...
                        <div class="widget-box">
							<div class="widget-title">
                                ...
                                <a href="<?php echo U('Export/code',array('pid'=>$pid,'type'=>$type,'batch'=>$batch,'source'=>$source,'startdate'=>$startdate,'enddate'=>$enddate,'cid'=>$cid));?>" class="phonenone"><span class="label btn-warning"><i class=" icon-download-alt icon-white"></i> 导出</span></a>
                               
                              
                                <a href="<?php echo U('Codecard/card_edit');?>"><span class="label btn-success"><i class="icon-plus icon-white"></i> 生成多选卡</span></a>
                                <a href="<?php echo U('Codecard/card_type');?>"><span class="label btn-success"><i class="icon-plus icon-white"></i> 兑换券类别</span></
							</div>
							<div class="widget-content">
								...
								<table class="table table-bordered table-striped with-check" id="maxtable">
                                    ...
                                    <?php if(is_array($rechargecardlist)): foreach($rechargecardlist as $key=>$row): ?><tr>
                                            ...
                                            <td><?php echo ($row["charge_to_device_uuid"]); ?></td>
                                            ...
                                            <td class="taskOptions">
                                            	<a href="javascript:;" onClick="javascript:window.location.href='<?php echo U('Code/rechargecard_edit',array('id'=>$row['id']));?>';" class="tip-top" data-original-title="Update" title="Update"><i class="icon-pencil"></i></a>
                                            </td>
                                           
                                           
                                            <td class="taskOptions">
                                                <a href="javascript:;" onClick="javascript:ConfirmDel('<?php echo U('Delete/rechargecard',array('id'=>$row['id']));?>');" class="tip-top" data-original-title="Delete" title="Delete"><i class="icon-remove"></i></a>
                                            </td>
