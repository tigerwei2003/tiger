...
<link rel="stylesheet" href="/gloudapi2/Public/static/css/uniform.css" />
		...
		<div id="content">
			...
			<div id="breadcrumb">
				...
				<a href="javascript:;" class="current">每日区域统计</a>
					...
					<div class="span12">
                            ...
                            <tbody>
                            	<tr>
                                    ...
                                    <select name="region_id">
                                        ...
                                        <?php if(is_array($region)): $i = 0; $__LIST__ = $region;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><option value="<?php echo ($data['id']); ?>" <?php if($data['id']==$region_id){echo 'selected';} ?> ><?php echo ($data['name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>   
                                    </select>
                                    </td>
                                    <td>
                        ...
                        <div class="widget-box">
							<div class="widget-title">
                                ...
                                <a href="<?php echo U('Export/regionchart',array('city'=>$city,'startdate'=>$startdate,'enddate'=>$enddate));?>"><span class="label btn-warning"><i class=" icon-download-alt icon-white"></i> 导出</span></a>
