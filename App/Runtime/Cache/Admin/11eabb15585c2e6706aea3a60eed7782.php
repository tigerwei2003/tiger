...
<div id="content">
	...
	<div id="breadcrumb">
		<a href="<?php echo U('Index/index');?>" title="Go to Home" class="tip-bottom"><i
			class="icon-home"></i> 后台首页</a> <a href="<?php echo U('Record/payment');?>"
			class="current">虚拟币消费记录</a> <a href="javascript:;"
						...
						<table rules="none" border="0">
							<tbody>
								<tr>
									...
									<td style="padding-right: 0"><input type="text"
										name="name"
										value="<?php if($name){ echo $name;}else{ echo '消费计费点';} ?>"
										onBlur="blur_input(this,'消费计费点')"
										onClick="click_input(this,'消费计费点')"></td>
									<td style="padding-right: 0"><input type="text"
										name="startdate"
					...
					<div class="widget-content">
						<div class="cont_max">
							<table class="table table-bordered table-striped with-check"
								...
								<tbody>
									<?php if(is_array($paymentlist)): foreach($paymentlist as $key=>$row): ?><tr>
