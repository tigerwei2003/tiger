...
<link rel="stylesheet" href="/gloudapi2/Public/static/css/uniform.css" />
		...
		<div id="content">
			...
			<div id="breadcrumb">
				...
				<a href="<?php echo U('Code/rechargecard');?>" class="current">充值卡管理</a>
					...
					<div class="span12">
						...
						<div class="widget-box">
							<div class="widget-title">
                                ...
                                <a href="<?php echo U('Code/rechargecard');?>"><span class="label btn-primary"><i class=" icon-list-alt icon-white"></i> 充值卡管理</span></a>
                               
							</div>
							<div class="widget-content nopadding">
								<form class="form-horizontal" method="post" action="<?php echo U('Code/rechargecard_edit');?>" name="basic_validate" id="basic_validate" enctype="multipart/form-data" novalidate >
