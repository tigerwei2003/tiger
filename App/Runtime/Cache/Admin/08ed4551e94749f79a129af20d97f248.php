...
<link rel="stylesheet" href="/gloudapi2/Public/static/css/uniform.css" />
		...
		<div id="content">
			...
			<div id="breadcrumb">
				...
				<a href="<?php echo U('Codecard/card_mul');?>" class="current">多选卡管理</a>
                <a href="<?php echo U('Codecard/card_type');?>" class="current">多选卡类别管理</a>
					...
					<div class="span12">
                        <div class="widget-box">
							<div class="widget-title">
                                ...
                                <a href="<?php echo U('Codecard/card_type_edit');?>"><span class="label btn-success"><i class="icon-plus icon-white"></i> 添加类别</span></a>
                                
                              
                                <a href="<?php echo U('Codecard/card_edit');?>"><span class="label btn-success"><i class="icon-plus icon-white"></i> 生成兑换券</span></a>
