...
<div id="content">
	...
	<div id="breadcrumb">
		<a href="<?php echo U('Index/index');?>" title="Go to Home" class="tip-bottom"><i
			class="icon-home"></i> 后台首页</a> <a href="javascript:;" class="current">每日统计</a>
			...
			<div class="span12">
				...
				<div class="widget-box">
					<div class="widget-title">
						...
						<h5>每日统计明细</h5>
						 <a
							href="<?php echo U('Export/dailychart');?>"><span
							...
							<table class="table table-bordered table-striped with-check"
								...
								<tbody>
									<?php if(is_array($datalist)): foreach($datalist as $key=>$row): ?><tr>
										...
										<td><?php echo ($row["daily_new_valid_account"]); ?></td>
										<td><?php echo ($row["max_concurrent_user"]); ?></td>
										<td><?php echo ($row["daily_play_time"]); ?></td>
										<td><?php echo ($row["daily_average_time"]); ?></td>
										<td><?php echo ($row["daily_used_coin"]); ?></td>
										<td><?php echo ($row["daily_used_income_coin"]); ?></td>
										<td><?php echo ($row["daily_trial_count"]); ?></td>
										<td><?php echo ($row["daily_console_game"]); ?></td>
										<td><?php echo ($row["daily_insert_coin"]); ?></td>
