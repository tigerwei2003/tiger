...
<link rel="stylesheet" href="/gloudapi2/Public/static/css/uniform.css" />
		...
		<div id="content">
			...
			<div id="breadcrumb">
                ...
                <a href="<?php echo U('Checkcardtype/Edit');?>" class="current">多选卡类别管理</a>
					...
					<div class="span12">
                        <div class="widget-box">
							<div class="widget-title">
                                ...
                                <a href="<?php echo U('Checkcardtype/Edit');?>"><span class="label btn-success"><i class="icon-plus icon-white"></i> 添加类别</span></a>
                                
                              
                                <a href="<?php echo U('Checkcard/Edit');?>"><span class="label btn-success"><i class="icon-plus icon-white"></i> 生成兑换券</span></a>
								...
								<table class="table table-bordered table-striped with-check" id="maxtable">
									<thead>
										<tr>
											...
											<th width="400">备注</th>
                                            <th >创建时间</th>
                                            <th width="100" class="taskOptions">创建者</th>
                                    ...
                                    <?php if(is_array($typelist)): foreach($typelist as $key=>$row): ?><tr>
                                            ...
                                            <td class="taskOptions">
                                                <?php echo ($row["admin"]); ?></a>
                                            </td>
                                           
                                          
                                            <td class="taskOptions">
                                            	<a href="javascript:;" onClick="javascript:window.location.href='<?php echo U('Checkcardtype/Edit',array('id'=>$row['id']));?>';" class="tip-top" data-original-title="Update" title="Update"><i class="icon-pencil"></i></a>
                                            </td>
                                            
                                           <!-- 
                                            <td class="taskOptions">
                                                <a href="javascript:;" onClick="javascript:ConfirmDel('<?php echo U('Checkcardtype/Del',array('id'=>$row['id']));?>');" class="tip-top" data-original-title="Delete" title="Delete"><i class="icon-remove"></i></a>
                                            </td>-->
