...
<div id="content">
	...
	<div id="breadcrumb">
		<a href="<?php echo U('Index/index');?>" title="Go to Home" class="tip-bottom"><i
			class="icon-home"></i> 后台首页</a> <a href="<?php echo U('Log/index');?>"
					...
					<div class="widget-content">
						<div class="cont_max">
							<table class="table table-bordered table-striped with-check"
								...
								<tbody>
									<?php if(is_array($loglist)): foreach($loglist as $key=>$row): ?><tr>
										...
										<td><?php if($row['recording_time']): echo (date('Y-m-d
											H:i:s',$row["recording_time"])); endif; ?></td>
										<td class="taskOptions"><a href="javascript:;"
											onClick="javascript:logmore(<?php echo ($row["id"]); ?>)" class="tip-top"
...
<script type="text/javascript">
	function logmore(id){
		if(id){
			$.get("/gloudapi2/op.php?c=Admin&m=Log&a=showmore&id="+id, function(result){
				if(result){
