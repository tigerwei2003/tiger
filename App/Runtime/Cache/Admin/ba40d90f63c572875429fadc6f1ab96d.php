...
<link rel="stylesheet" href="/gloudapi2/Public/static/css/uniform.css" />
		...
		<div id="content">
			...
			<div id="breadcrumb">
				...
				<a href="<?php echo U('Code/rechargecard');?>" class="current">充值卡销售记录</a>
					...
					<div class="span12">
                        ...
                        <div class="widget-box">
							<div class="widget-title">
                                ...
                                <a href="<?php echo U('Code/rechargecard_edit');?>"><span class="label btn-success"><i class="icon-plus icon-white"></i> 生成充值卡</span></a>
