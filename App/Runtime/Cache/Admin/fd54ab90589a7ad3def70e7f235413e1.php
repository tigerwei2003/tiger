			...
			<div class="span12">
							...
							<tbody>
								<tr>
									<td class="searchselect"><select name="game_id">
											...
											<?php if(is_array($game)): $i = 0; $__LIST__ = $game;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><option value="<?php echo ($data['game_id']); ?>"
												<?php if($data['game_id']==$game_id){echo 'selected';} ?>
												><?php echo ($data['game_id']); ?>:<?php echo ($data['game_name']); ?>
											</option><?php endforeach; endif; else: echo "" ;endif; ?>
									</select></td>
									<td style="padding-right: 0"><input type="text"
										name="game_name"
										value="<?php if($game_name){ echo $game_name;}else{ echo '游戏名称';} ?>"
				...
				<div class="widget-box">
					<div class="widget-title">
						...
						<h5>每日游戏统计明细</h5>
						 <a
							href="<?php echo U('Export/gamechart',array('game_id'=>$game_id,'game_name'=>$game_name,'startdate'=>$startdate,'enddate'=>$enddate));?>"><span
