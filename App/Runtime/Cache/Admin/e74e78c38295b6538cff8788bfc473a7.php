			...
			<div class="span12">
				<div class="widget-box">
					<div class="widget-title">
						...
						<h5>渠道列表</h5>
						<a href="<?php echo U('Dealer/add');?>"><span class="label btn-success"><i
								class="icon-plus icon-white"></i> 新增渠道</span></a>
					</div>
					<div class="widget-content">
						<div class="cont_max">
							<table class="table table-bordered table-striped with-check"
								...
								<tbody>
									<?php if(is_array($dealer)): foreach($dealer as $key=>$row): ?><tr>
										<td><?php echo ($row["id"]); ?></td>
										<td><?php echo ($row["dealer_name"]); ?></td>
										<td class="taskOptions"><a href="javascript:;"
											onClick="javascript:window.location.href='<?php echo U('Dealer/edit',array('id'=>$row['id']));?>';"
											class="tip-top" data-original-title="Update" title="修改资料"><i
												class="icon-pencil"></i></a></td>
										<td class="taskOptions"><a href="javascript:;"
											onClick="javascript:ConfirmDel('<?php echo U('Dealer/delete',array('id'=>$row['id']));?>');"
											class="tip-top" data-original-title="Delete" title="删除渠道"><i
