...
<div id="content">
	...
	<div id="breadcrumb">
		<a href="<?php echo U('Index/index');?>" title="Go to Home" class="tip-bottom"><i
			class="icon-home"></i> 后台首页</a> <a href="<?php echo U('Role/add');?>"
			class="current">添加角色</a> <a href="javascript:;"
			...
			<div class="span12">
				...
				<div class="widget-box">
					<div class="widget-title">
						...
						<h5>编辑角色</h5>
						<a href="<?php echo U('Role/index');?>"><span class="label btn-primary"><i
								class=" icon-list-alt icon-white"></i> 角色管理</span></a>
					</div>
					<div class="widget-content nopadding">
						<form class="form-horizontal" method="post" action=""
							...
							<div class="control-group">
								<label class="control-label">角色名（英文）</label>
								<div class="controls">
									<input type="text" name="name" id="rolename" value="<?php echo ($role_info["name"]); ?>" required />
								</div>
							</div>
							<div class="control-group">
								<label class="control-label">角色描述</label>
								<div class="controls">
									<input type="text" name="remark" id="remark" value="<?php echo ($role_info["remark"]); ?>" required />
								</div>
							</div>
							<div class="control-group">
								<label class="control-label">状态</label>
								<div class="controls">
								<?php if($role_info['status'] == 1): ?><label><input style="margin-top: -2px;" type="radio"
										name="status" value="1" checked /> 启用</label> 
										<label><input
										style="margin-top: -2px;" type="radio" name="status"
										value="0" /> 停用</label>
										<?php else: ?>
										<label><input style="margin-top: -2px;" type="radio"
										name="status" value="1"  /> 启用</label> 
										<label><input
										style="margin-top: -2px;" type="radio" name="status"
										value="0" checked /> 停用</label><?php endif; ?>
