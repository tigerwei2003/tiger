							...
							<table class="table table-bordered table-striped with-check"
								...
								<thead>
									<tr>
										...
										<th width="80">类型</th>
										<th width="80">状态</th>
										<th width="40" class="taskOptions">添加</th>
								...
								<tbody>
									<?php if(is_array($parent_menu_arr['parent'])): $i = 0; $__LIST__ = $parent_menu_arr['parent'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr id="quanxian<?php echo ($vo['id']); ?>" bgcolor="#ccc"
										onclick="check(<?php echo ($vo['id']); ?>)">
										<td>&nbsp;<a href=''><?php echo ($vo['url']); ?></a></td>
										<td><?php echo ($vo['title']); ?></td>
										<td>顶级菜单</td>
										<td><?php echo ($vo["status"]); ?></td>
										<td class="taskOptions">
                                            	<a href="javascript:;" onClick="javascript:window.location.href='<?php echo U('Node/add',array('pid'=>$vo['id'],'level'=>2));?>';" class="tip-top" data-original-title="Games" title="Games"><i class="icon-plus"></i></a>
                                            </td>
										<td class="taskOptions">
                                            	<a href="javascript:;" onClick="javascript:window.location.href='<?php echo U('Node/modify',array('id'=>$vo['id']));?>';" class="tip-top" data-original-title="Update" title="Update"><i class="icon-pencil"></i></a>
                                            </td>
										<td class="taskOptions">
                                                <a href="javascript:;" onClick="javascript:ConfirmDel('<?php echo U('Node/delete',array('id'=>$vo['id'],'level'=>1));?>');" class="tip-top" data-original-title="Delete" title="Delete"><i class="icon-remove"></i></a>
                                            </td>
									</tr>
									<?php if(is_array($parent_menu_arr['child'][$vo['id']])): $i = 0; $__LIST__ = $parent_menu_arr['child'][$vo['id']];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$voo): $mod = ($i % 2 );++$i;?><tr class="cc<?php echo ($vo['id']); ?>" style="display:">
										...
										<td><?php echo ($vo["status"]); ?></td>
										<td class="taskOptions">
                                            	<a href="javascript:;" onClick="javascript:window.location.href='<?php echo U('Node/add',array('pid'=>$voo['id'],'level'=>3));?>';" class="tip-top" data-original-title="Games" title="Games"><i class="icon-plus"></i></a>
                                            </td>
										<td class="taskOptions">
                                            	<a href="javascript:;" onClick="javascript:window.location.href='<?php echo U('Node/modify',array('id'=>$voo['id']));?>';" class="tip-top" data-original-title="Update" title="Update"><i class="icon-pencil"></i></a>
                                            </td>
										<td class="taskOptions">
                                                <a href="javascript:;" onClick="javascript:ConfirmDel('<?php echo U('Node/delete',array('id'=>$voo['id'],'level'=>2));?>');" class="tip-top" data-original-title="Delete" title="Delete"><i class="icon-remove"></i></a>
                                            </td>
									</tr>
									...
									<?php if(is_array($parent_menu_arr['func'][$voo['id']])): $i = 0; $__LIST__ = $parent_menu_arr['func'][$voo['id']];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vooo): $mod = ($i % 2 );++$i;?><tr class="cc<?php echo ($vo['id']); ?>" style="display:">
										...
										<td class="taskOptions">
                                            	<a href="javascript:;" onClick="javascript:window.location.href='<?php echo U('Node/modify',array('id'=>$vooo['id']));?>';" class="tip-top" data-original-title="Update" title="Update"><i class="icon-pencil"></i></a>
                                            </td>
										<td class="taskOptions">
                                                <a href="javascript:;" onClick="javascript:ConfirmDel('<?php echo U('Node/delete',array('id'=>$vooo['id'],'level'=>3));?>');" class="tip-top" data-original-title="Delete" title="Delete"><i class="icon-remove"></i></a>
                                            </td>
