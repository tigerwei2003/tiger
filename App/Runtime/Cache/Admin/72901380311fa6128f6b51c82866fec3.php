...
<div id="content">
	...
	<div id="breadcrumb">
		<a href="<?php echo U('Index/index');?>" title="Go to Home" class="tip-bottom"><i
			class="icon-home"></i> 后台首页</a> <a href="<?php echo U('Tools/upload_avatar');?>"
			class="current">头像上传</a> <a href="javascript:;"
				...
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						<form class="form-horizontal" method="post"
							action="<?php echo U('Tools/upload_avatar');?>" name="basic_validate"
						...
						<div class="control-group">
							...
							<div class="controls">
								<select name="info[type]" id="type" onchange="check()">
						...
						<div class="control-group game_save_compressed_md5" id="file">
							<label class="control-label">请选择一个图片文件：</label>
							<div class="controls">
