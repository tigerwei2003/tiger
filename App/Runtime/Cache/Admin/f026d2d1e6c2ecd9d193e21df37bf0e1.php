...
<div id="content">
	...
	<div id="breadcrumb">
		<a href="<?php echo U('Index/index');?>" title="Go to Home" class="tip-bottom"><i
			class="icon-home"></i> 后台首页</a> <a href="<?php echo U('Tools/recharge');?>"
...
<script type="text/javascript">
					...
					success : function(e) {
						{
							...
							flag = 1;
							$.getJSON("<?php echo U('Tools/get_actid');?>",{"account_id" : account_id},
											function(data) {
												if (data != "-1") {
													$("#device_uuid").val(
															data.device_uuid);
	...
	function post_use_recharge_card() {
		...
		var url = "/gloudapi2/api.php?m=Client&a=use_recharge_card";
		$.getJSON(url, {
			"deviceid" : deviceid,
