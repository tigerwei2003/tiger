...
<div id="content">
	...
	<div id="breadcrumb">
		<a href="<?php echo U('Index/index');?>" title="Go to Home" class="tip-bottom"><i
			class="icon-home"></i> 后台首页</a> <a href="<?php echo U('Rechargecard/index');?>"
			class="current">已售充值卡</a> <a href="javascript:;"
			...
			<div class="span12">
				<div class="widget-box">
					<div class="widget-title">
						...
						<h5>激活充值卡</h5>
						<a href="<?php echo U('Rechargecard/index');?>"><span
							class="label btn-primary"><i
								class=" icon-list-alt icon-white"></i> 已售充值卡</span></a>
					</div>
					<div class="widget-content nopadding">
						...
						<div class="control-group">
							<label class="control-label">激活人姓名</label>
							<div class="controls">
								<input type="text" name="sales" value="" id="sales" />
							</div>
						</div>
						<div class="control-group">
						...
						<div class="form-actions">
							<input type="submit" value="激活" class="btn btn-primary" />
						</div>
						</form>
					</div>
				</div>
