...
<div id="content">
	...
	<div id="breadcrumb">
		<a href="<?php echo U('Index/index');?>" title="Go to Home" class="tip-bottom"><i
			class="icon-home"></i> 后台首页</a> <a href="<?php echo U('Role/index');?>"
			class="current">角色管理</a> <a href="javascript:;"
			...
			<div class="span12">
				<div class="widget-box">
					<div class="widget-title">
						...
						<h5>角色管理</h5>
						<a href="<?php echo U('Role/add');?>"><span class="label btn-success"><i
								class="icon-plus icon-white"></i> 创建角色</span></a>
					</div>
							...
							<table class="table table-bordered table-striped with-check"
								...
								<thead>
									<tr>
										...
										<th width="40" class="taskOptions">权限</th>
								...
								<tbody>
									<?php if(is_array($list)): foreach($list as $key=>$row): ?><tr>
										...
										<td><?php if($row['status']==1): ?>启用<?php else: ?>停用<?php endif; ?></td>

										<td class="taskOptions"><a href="javascript:;"
											onClick="javascript:window.location.href='<?php echo U('Role/modify',array('id'=>$row['id']));?>';"
											class="tip-top" data-original-title="Update" title="Update"><i
												class="icon-pencil"></i></a></td>


										<td class="taskOptions"><a href="javascript:;"
											onClick="javascript:window.location.href='<?php echo U('Role/priv',array('roleid'=>$row['id']));?>';"
											class="tip-top" data-original-title="Games" title="Games"><i
												class="icon-list-alt"></i></a></td>


										<td class="taskOptions"><a href="javascript:;"
											onClick="javascript:ConfirmDel('<?php echo U('Role/delete',array('id'=>$row['id']));?>');"
