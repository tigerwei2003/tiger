...
var popUpCal = {
    ...
    showCalendar: function() {
        ...
        if (this.timeSeparators.length > 1) {
            timeSelect += '<div id="calendar_time"><div class="select" style="width:37px;margin-left:55px;"><select id="calendar_hour" style="width:50px">';
            ...
            timeSelect += '</select></div><div class="select" style=" width:10px;">' + this.timeSeparators[1] + '</div> <div class="select" style="width:37px"><select id="calendar_minute" style="width:50px">';
            for (var a = 0; a <= 59; a++) {
    ...
    showTime: function() {
        ...
        var timeSelect = '';
        if (this.timeSeparators.length > 1) {
            timeSelect += '<div id="calendar_time"><div class="select" style="width:37px;margin-left:25px;"><select id="calendar_hour" style="width:50px">';
            if (this.timeSeparators.length == 4) {
                if (this.selectedHour == 12 || this.selectedHour == 0) timeSelect += '<option value="12" selected="selected">12</option>';
                else timeSelect += '<option value="12">12</option>';
                for (var a = 1; a < 12; a++) {
